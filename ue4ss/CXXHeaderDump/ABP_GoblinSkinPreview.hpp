#ifndef UE4SS_SDK_ABP_GoblinSkinPreview_HPP
#define UE4SS_SDK_ABP_GoblinSkinPreview_HPP
...
class UABP_GoblinSkinPreview_C : public UAnimInstance
{
    ...
    void ExecuteUbergraph_ABP_GoblinSkinPreview(int32 EntryPoint);
}; // Size: 0x58E8
