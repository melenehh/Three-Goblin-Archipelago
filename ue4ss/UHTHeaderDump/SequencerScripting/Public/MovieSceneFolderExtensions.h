...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static bool RemoveChildMasterTrack(UMovieSceneFolder* Folder, UMovieSceneTrack* InTrack);
    ...
    UFUNCTION(BlueprintCallable)
    static bool AddChildMasterTrack(UMovieSceneFolder* Folder, UMovieSceneTrack* InTrack);
