...
UNavigationSystemV1::UNavigationSystemV1() {
    ...
    this->GeometryExportTriangleCountWarningThreshold = 200000;
...
TEnumAsByte<ENavigationQueryResult::Type> UNavigationSystemV1::GetPathLength(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, double& PathLength, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass) {
    return ENavigationQueryResult::Invalid;
}

TEnumAsByte<ENavigationQueryResult::Type> UNavigationSystemV1::GetPathCost(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, double& PathCost, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass) {
    return ENavigationQueryResult::Invalid;
}
