...
#include "RigHierarchyModifiedDynamicEventDelegate.h"
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    EEulerRotationOrder GetControlPreferredEulerRotationOrder(FRigElementKey InKey, bool bFromSettings) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FVector GetControlPreferredEulerAnglesByIndex(int32 InElementIndex, EEulerRotationOrder InRotationOrder, bool bInitial) const;
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FVector GetControlPreferredEulerAngles(FRigElementKey InKey, EEulerRotationOrder InRotationOrder, bool bInitial) const;
