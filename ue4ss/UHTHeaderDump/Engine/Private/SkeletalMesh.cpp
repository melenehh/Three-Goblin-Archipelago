...
USkeletalMesh::USkeletalMesh() {
    ...
    this->PostProcessAnimBPLODThreshold = -1;
...
void USkeletalMesh::SetOverlayMaterial(UMaterialInterface* NewOverlayMaterial) {
}
...
float USkeletalMesh::GetOverlayMaterialMaxDrawDistance() const {
    return 0.0f;
}

UMaterialInterface* USkeletalMesh::GetOverlayMaterial() const {
    return NULL;
}
