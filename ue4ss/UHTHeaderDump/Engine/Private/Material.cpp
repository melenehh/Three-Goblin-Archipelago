...
UMaterial::UMaterial() {
    ...
    this->bRootNodeOverridesDefaultDistortion = false;
    ...
    this->bUsedWithHeterogeneousVolumes = false;
    ...
    this->RefractionMethod = RM_None;
    this->RefractionCoverageMode = RCM_CoverageAccountedFor;
    ...
    this->bAlwaysEvaluateWorldPositionOffset = false;
}
