#ifndef UE4SS_SDK_ABP_GoblinCorpse_Asmon_HPP
#define UE4SS_SDK_ABP_GoblinCorpse_Asmon_HPP

struct FAnimBlueprintGeneratedConstantData : public FAnimBlueprintConstantData
{
    FName __NameProperty_37;                                                          // 0x0004 (size: 0x8)
    bool __BoolProperty_38;                                                           // 0x000C (size: 0x1)
    float __FloatProperty_39;                                                         // 0x0010 (size: 0x4)
    FInputScaleBiasClampConstants __StructProperty_40;                                // 0x0014 (size: 0x2C)
    float __FloatProperty_41;                                                         // 0x0040 (size: 0x4)
    bool __BoolProperty_42;                                                           // 0x0044 (size: 0x1)
    EAnimSyncMethod __EnumProperty_43;                                                // 0x0045 (size: 0x1)
    TEnumAsByte<EAnimGroupRole::Type> __ByteProperty_44;                              // 0x0046 (size: 0x1)
    FName __NameProperty_45;                                                          // 0x0048 (size: 0x8)
    FAnimNodeFunctionRef __StructProperty_46;                                         // 0x0050 (size: 0x20)
...
class UABP_GoblinCorpse_Asmon_C : public UAnimInstance
{
    ...
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone_2;                                  // 0x2B70 (size: 0x128)
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone_1;                                  // 0x2C98 (size: 0x128)
    FAnimNode_ModifyBone AnimGraphNode_ModifyBone;                                    // 0x2DC0 (size: 0x128)

    void AnimGraph(FPoseLink& AnimGraph);
    void ExecuteUbergraph_ABP_GoblinCorpse_Asmon(int32 EntryPoint);
}; // Size: 0x2EE8
