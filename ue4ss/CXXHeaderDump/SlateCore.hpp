...
struct FTextBlockStyle : public FSlateWidgetStyle
{
    FSlateFontInfo Font;                                                              // 0x0008 (size: 0x58)
    FSlateColor ColorAndOpacity;                                                      // 0x0060 (size: 0x14)
    FDeprecateSlateVector2D ShadowOffset;                                             // 0x0074 (size: 0x8)
    FLinearColor ShadowColorAndOpacity;                                               // 0x007C (size: 0x10)
    FSlateColor SelectedBackgroundColor;                                              // 0x008C (size: 0x14)
    FSlateColor HighlightColor;                                                       // 0x00A0 (size: 0x14)
