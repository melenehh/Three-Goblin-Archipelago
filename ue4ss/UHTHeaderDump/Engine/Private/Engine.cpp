...
UEngine::UEngine() {
    ...
    this->NaniteHiddenSectionMaterial = NULL;
    this->NaniteHiddenSectionMaterialName = TEXT("/Engine/EngineMaterials/NaniteHiddenSectionMaterial.NaniteHiddenSectionMaterial");
    ...
    this->UseGrassVarityPerQualityLevels = false;
