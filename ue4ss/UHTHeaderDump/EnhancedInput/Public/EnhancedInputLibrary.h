...
public:
    ...
    static bool IsActionKeyMappingPlayerMappable(const FEnhancedActionKeyMapping& ActionKeyMapping);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPlayerMappableKeySlot GetThirdPlayerMappableKeySlot();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPlayerMappableKeySlot GetSecondPlayerMappableKeySlot();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static UPlayerMappableKeySettings* GetPlayerMappableKeySettings(const FEnhancedActionKeyMapping& ActionKeyMapping);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FName GetMappingName(const FEnhancedActionKeyMapping& ActionKeyMapping);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPlayerMappableKeySlot GetFourthPlayerMappableKeySlot();
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FPlayerMappableKeySlot GetFirstPlayerMappableKeySlot();
