...
UProjectileMovementComponent::UProjectileMovementComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->bThrottleInterpolation = false;
    this->bInterpolationUseScopedMovement = true;
    ...
    this->ThrottleInterpolationThresholdNotRenderedShortTime = 0.20f;
    this->ThrottleInterpolationThresholdNotRenderedLongTime = 1.00f;
    this->ThrottleInterpolationSkipFramesRecent = 1;
    this->ThrottleInterpolationSkipFramesNotRecent = 2;
}
