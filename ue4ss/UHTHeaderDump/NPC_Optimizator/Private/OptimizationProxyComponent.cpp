...
UOptimizationProxyComponent::UOptimizationProxyComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->FirstWave_MovementMode = MOVE_NavWalking;
    ...
    this->SecondWave_MovementMode = MOVE_NavWalking;
    ...
    this->ThirdWave_MovementMode = MOVE_NavWalking;
    ...
    this->Invisible_MovementMode = MOVE_NavWalking;
