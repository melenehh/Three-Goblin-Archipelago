...
#include "ESpawnActorScaleMethod.h"
...
public:
    ...
    static bool SuggestProjectileVelocity_MovingTarget(const UObject* WorldContextObject, FVector& OutLaunchVelocity, FVector ProjectileStartLocation, AActor* TargetActor, FVector TargetLocationOffset, double GravityZOverride, double TimeToTarget, TEnumAsByte<EDrawDebugTrace::Type> DrawDebugType, float DrawDebugTime, FLinearColor DrawDebugColor);
