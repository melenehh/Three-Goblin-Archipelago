...
struct FHairGroupInfo
{
    ...
    int32 GroupCardsID;                                                               // 0x0020 (size: 0x4)
...
{
    EGroomLODType LODType;                                                            // 0x0000 (size: 0x1)
...
class UGroomAsset : public UObject
{
    ...
    bool EnableGlobalInterpolation;                                                   // 0x00B0 (size: 0x1)
    bool EnableSimulationCache;                                                       // 0x00B1 (size: 0x1)
    EGroomInterpolationType HairInterpolationType;                                    // 0x00B2 (size: 0x1)
    class USkeletalMesh* RiggedSkeletalMesh;                                          // 0x00B8 (size: 0x8)
    TArray<int32> DeformedGroupSections;                                              // 0x00C0 (size: 0x10)
    FPerPlatformInt MinLOD;                                                           // 0x00D0 (size: 0x4)
    FPerPlatformBool DisableBelowMinLodStripping;                                     // 0x00D4 (size: 0x1)
    TArray<float> EffectiveLODBias;                                                   // 0x00D8 (size: 0x10)
    TArray<class UAssetUserData*> AssetUserData;                                      // 0x00F8 (size: 0x10)
...
{
    class UGroomAsset* GroomAsset;                                                    // 0x05B8 (size: 0x8)
    class UGroomCache* GroomCache;                                                    // 0x05C0 (size: 0x8)
    TArray<class UNiagaraComponent*> NiagaraComponents;                               // 0x05C8 (size: 0x10)
    class USkeletalMesh* SourceSkeletalMesh;                                          // 0x05D8 (size: 0x8)
    class UGroomBindingAsset* BindingAsset;                                           // 0x05E0 (size: 0x8)
    class UPhysicsAsset* PhysicsAsset;                                                // 0x05E8 (size: 0x8)
    FHairSimulationSettings SimulationSettings;                                       // 0x0600 (size: 0x90)
    class UMeshDeformer* MeshDeformer;                                                // 0x0690 (size: 0x8)
    class UMeshDeformerInstance* MeshDeformerInstance;                                // 0x0698 (size: 0x8)
    class UMeshDeformerInstanceSettings* MeshDeformerInstanceSettings;                // 0x06A0 (size: 0x8)
    class UMaterialInterface* Strands_DebugMaterial;                                  // 0x06A8 (size: 0x8)
    class UMaterialInterface* Strands_DefaultMaterial;                                // 0x06B0 (size: 0x8)
    class UMaterialInterface* Cards_DefaultMaterial;                                  // 0x06B8 (size: 0x8)
    class UMaterialInterface* Meshes_DefaultMaterial;                                 // 0x06C0 (size: 0x8)
    class UNiagaraSystem* AngularSpringsSystem;                                       // 0x06C8 (size: 0x8)
    class UNiagaraSystem* CosseratRodsSystem;                                         // 0x06D0 (size: 0x8)
    FString AttachmentName;                                                           // 0x06D8 (size: 0x10)
    TArray<FHairGroupDesc> GroomGroupsDesc;                                           // 0x0770 (size: 0x10)
    bool bUseCards;                                                                   // 0x0780 (size: 0x1)
    bool bRunning;                                                                    // 0x0781 (size: 0x1)
    bool bLooping;                                                                    // 0x0782 (size: 0x1)
    bool bManualTick;                                                                 // 0x0783 (size: 0x1)
    float ElapsedTime;                                                                // 0x0784 (size: 0x4)
