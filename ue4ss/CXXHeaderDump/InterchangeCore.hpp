...
struct FInterchangePipelinePropertyStates
{
    ...
    FInterchangePipelinePropertyStatePerContext ImportStates;                         // 0x0001 (size: 0x1)
    FInterchangePipelinePropertyStatePerContext ReimportStates;                       // 0x0002 (size: 0x1)
...
{
    class UInterchangeResultsContainer* Results;                                      // 0x0030 (size: 0x8)
    TMap<class FName, class FInterchangePipelinePropertyStates> PropertiesStates;     // 0x0038 (size: 0x50)
...
class UInterchangeResult : public UObject
{
    ...
    UClass* AssetType;                                                                // 0x0048 (size: 0x8)
    FString InterchangeKey;                                                           // 0x0050 (size: 0x10)

}; // Size: 0x60

class UInterchangeResultDisplay_Generic : public UInterchangeResultSuccess
{
    FText Text;                                                                       // 0x0060 (size: 0x18)
...
class UInterchangeUserDefinedAttributesAPI : public UObject
{
    ...
    bool CreateUserDefinedAttribute_Int32(class UInterchangeBaseNode* InterchangeNode, FString UserDefinedAttributeName, const int32& Value, FString PayloadKey);
    bool CreateUserDefinedAttribute_FString(class UInterchangeBaseNode* InterchangeNode, FString UserDefinedAttributeName, FString Value, FString PayloadKey);
    bool CreateUserDefinedAttribute_Float(class UInterchangeBaseNode* InterchangeNode, FString UserDefinedAttributeName, const float& Value, FString PayloadKey);
    bool CreateUserDefinedAttribute_Double(class UInterchangeBaseNode* InterchangeNode, FString UserDefinedAttributeName, const double& Value, FString PayloadKey);
    bool CreateUserDefinedAttribute_Boolean(class UInterchangeBaseNode* InterchangeNode, FString UserDefinedAttributeName, const bool& Value, FString PayloadKey);
}; // Size: 0x28
