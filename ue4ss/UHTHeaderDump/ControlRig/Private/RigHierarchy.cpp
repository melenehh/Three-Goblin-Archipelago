...
void URigHierarchy::SetControlPreferredRotatorByIndex(int32 InElementIndex, const FRotator& InRotator, bool bInitial, bool bFixEulerFlips) {
}

void URigHierarchy::SetControlPreferredRotator(FRigElementKey InKey, const FRotator& InRotator, bool bInitial, bool bFixEulerFlips) {
}

void URigHierarchy::SetControlPreferredRotationOrderByIndex(int32 InElementIndex, EEulerRotationOrder InRotationOrder) {
}

void URigHierarchy::SetControlPreferredRotationOrder(FRigElementKey InKey, EEulerRotationOrder InRotationOrder) {
}

void URigHierarchy::SetControlPreferredEulerAnglesByIndex(int32 InElementIndex, const FVector& InEulerAngles, EEulerRotationOrder InRotationOrder, bool bInitial, bool bFixEulerFlips) {
}

void URigHierarchy::SetControlPreferredEulerAngles(FRigElementKey InKey, const FVector& InEulerAngles, EEulerRotationOrder InRotationOrder, bool bInitial, bool bFixEulerFlips) {
}
...
TArray<FRigElementKey> URigHierarchy::GetRootElementKeys() const {
    return TArray<FRigElementKey>();
}
...
int32 URigHierarchy::GetLocalIndex_ForBlueprint(FRigElementKey InKey) const {
    return 0;
}
...
EEulerRotationOrder URigHierarchy::GetControlPreferredEulerRotationOrderByIndex(int32 InElementIndex, bool bFromSettings) const {
    return EEulerRotationOrder::XYZ;
}

EEulerRotationOrder URigHierarchy::GetControlPreferredEulerRotationOrder(FRigElementKey InKey, bool bFromSettings) const {
    return EEulerRotationOrder::XYZ;
}

FVector URigHierarchy::GetControlPreferredEulerAnglesByIndex(int32 InElementIndex, EEulerRotationOrder InRotationOrder, bool bInitial) const {
    return FVector{};
}

FVector URigHierarchy::GetControlPreferredEulerAngles(FRigElementKey InKey, EEulerRotationOrder InRotationOrder, bool bInitial) const {
    return FVector{};
}
