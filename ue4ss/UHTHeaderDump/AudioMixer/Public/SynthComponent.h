...
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=EModulationDestination -FallbackName=EModulationDestination
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=EModulationRouting -FallbackName=EModulationRouting
...
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=SoundModulationDefaultRoutingSettings -FallbackName=SoundModulationDefaultRoutingSettings
