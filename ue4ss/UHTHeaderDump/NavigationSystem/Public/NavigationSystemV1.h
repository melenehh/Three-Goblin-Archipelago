...
UCLASS(Blueprintable, MinimalAPI, NonTransient, Config=Engine, Within=World)
...
public:
    ...
    static TEnumAsByte<ENavigationQueryResult::Type> GetPathLength(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, double& PathLength, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass);
    
    UFUNCTION(BlueprintPure, meta=(WorldContext="WorldContextObject"))
    static TEnumAsByte<ENavigationQueryResult::Type> GetPathCost(UObject* WorldContextObject, const FVector& PathStart, const FVector& PathEnd, double& PathCost, ANavigationData* NavData, TSubclassOf<UNavigationQueryFilter> FilterClass);
