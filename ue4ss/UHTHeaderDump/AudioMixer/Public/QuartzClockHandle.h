...
public:
    ...
    UFUNCTION(BlueprintCallable, meta=(WorldContext="WorldContextObject"))
    void NotifyOnQuantizationBoundary(const UObject* WorldContextObject, FQuartzQuantizationBoundary InQuantizationBoundary, const FOnQuartzCommandEventBP& InDelegate, float InMsOffset);
