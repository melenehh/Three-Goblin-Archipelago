...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FSplinePoint GetSplinePointAt(int32 PointIndex, TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace) const;
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    float GetDistanceAlongSplineAtLocation(const FVector& InLocation, TEnumAsByte<ESplineCoordinateSpace::Type> CoordinateSpace) const;
