...
UCLASS(Abstract, Blueprintable, EditInlineNew, MinimalAPI, ClassGroup=Custom, Config=Engine, meta=(BlueprintSpawnableComponent))
...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    FTransform GetBoneTransform(FName InBoneName, TEnumAsByte<ERelativeTransformSpace> TransformSpace) const;
