...
#include "EDataflowWaveFunctionType.h"
#include "WaveScalarFieldDataflowNode.generated.h"
...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    EDataflowWaveFunctionType FunctionType;
    ...
    GEOMETRYCOLLECTIONNODES_API FWaveScalarFieldDataflowNode();
};
