...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FVector RandomUnitVectorInEllipticalConeInDegreesFromStream(const FRandomStream& Stream, const FVector& ConeDir, float MaxYawInDegrees, float MaxPitchInDegrees);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FVector RandomUnitVectorInConeInDegreesFromStream(const FRandomStream& Stream, const FVector& ConeDir, float ConeHalfAngleInDegrees);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static int32 RandomIntegerInRangeFromStream(const FRandomStream& Stream, int32 NewMin, int32 NewMax);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static int32 RandomIntegerInRange(int32 NewMin, int32 NewMax);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static int32 RandomIntegerFromStream(const FRandomStream& Stream, int32 NewMax);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static float RandomFloatInRangeFromStream(const FRandomStream& Stream, float NewMin, float NewMax);
