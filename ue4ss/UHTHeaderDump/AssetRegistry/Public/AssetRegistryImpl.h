...
public:
    ...
    UFUNCTION(BlueprintCallable)
    FAssetData K2_GetAssetByObjectPath(const FSoftObjectPath& ObjectPath, bool bIncludeOnlyOnDiskAssets, bool bSkipARFilteredAssets) const override PURE_VIRTUAL(K2_GetAssetByObjectPath, return FAssetData{};);
