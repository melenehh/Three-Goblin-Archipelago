...
FVector UKismetMathLibrary::RandomUnitVectorInEllipticalConeInDegreesFromStream(const FRandomStream& Stream, const FVector& ConeDir, float MaxYawInDegrees, float MaxPitchInDegrees) {
    return FVector{};
}
...
FVector UKismetMathLibrary::RandomUnitVectorInConeInDegreesFromStream(const FRandomStream& Stream, const FVector& ConeDir, float ConeHalfAngleInDegrees) {
    return FVector{};
}
...
int32 UKismetMathLibrary::RandomIntegerInRangeFromStream(const FRandomStream& Stream, int32 NewMin, int32 NewMax) {
    return 0;
}
...
int32 UKismetMathLibrary::RandomIntegerFromStream(const FRandomStream& Stream, int32 NewMax) {
    return 0;
}
...
float UKismetMathLibrary::RandomFloatInRangeFromStream(const FRandomStream& Stream, float NewMin, float NewMax) {
    return 0.0f;
}
