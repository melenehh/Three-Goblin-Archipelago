...
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, Instanced, NonPIEDuplicateTransient, NonTransactional, TextExportTransient, meta=(AllowPrivateAccess=true))
    TArray<ULandscapeNaniteComponent*> NaniteComponents;
