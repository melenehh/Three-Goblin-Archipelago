...
{
    class UPaperFlipbookComponent* Sprite;                                            // 0x0678 (size: 0x8)
...
{
    class UPaperFlipbook* SourceFlipbook;                                             // 0x05A8 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x05B0 (size: 0x8)
    float PlayRate;                                                                   // 0x05B8 (size: 0x4)
    uint8 bLooping;                                                                   // 0x05BC (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x05BC (size: 0x1)
    uint8 bPlaying;                                                                   // 0x05BC (size: 0x1)
    float AccumulatedTime;                                                            // 0x05C0 (size: 0x4)
    int32 CachedFrameIndex;                                                           // 0x05C4 (size: 0x4)
    FLinearColor SpriteColor;                                                         // 0x05C8 (size: 0x10)
    class UBodySetup* CachedBodySetup;                                                // 0x05D8 (size: 0x8)
    FPaperFlipbookComponentOnFinishedPlaying OnFinishedPlaying;                       // 0x05E0 (size: 0x10)
...
{
    TArray<class UMaterialInterface*> InstanceMaterials;                              // 0x05A8 (size: 0x10)
    TArray<FSpriteInstanceData> PerInstanceSpriteData;                                // 0x05B8 (size: 0x10)
...
{
    class UPaperSprite* SourceSprite;                                                 // 0x05A8 (size: 0x8)
    class UMaterialInterface* MaterialOverride;                                       // 0x05B0 (size: 0x8)
...
{
    class UPaperTerrainMaterial* TerrainMaterial;                                     // 0x0570 (size: 0x8)
    bool bClosedSpline;                                                               // 0x0578 (size: 0x1)
    bool bFilledSpline;                                                               // 0x0579 (size: 0x1)
    class UPaperTerrainSplineComponent* AssociatedSpline;                             // 0x0580 (size: 0x8)
    int32 RandomSeed;                                                                 // 0x0588 (size: 0x4)
    float SegmentOverlapAmount;                                                       // 0x058C (size: 0x4)
    FLinearColor TerrainColor;                                                        // 0x0590 (size: 0x10)
    int32 ReparamStepsPerSegment;                                                     // 0x05A0 (size: 0x4)
    TEnumAsByte<ESpriteCollisionMode::Type> SpriteCollisionDomain;                    // 0x05A4 (size: 0x1)
    float CollisionThickness;                                                         // 0x05A8 (size: 0x4)
    class UBodySetup* CachedBodySetup;                                                // 0x05B0 (size: 0x8)
...
{
    int32 MapWidth;                                                                   // 0x05A8 (size: 0x4)
    int32 MapHeight;                                                                  // 0x05AC (size: 0x4)
    int32 TileWidth;                                                                  // 0x05B0 (size: 0x4)
    int32 TileHeight;                                                                 // 0x05B4 (size: 0x4)
    class UPaperTileSet* DefaultLayerTileSet;                                         // 0x05B8 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x05C0 (size: 0x8)
    TArray<class UPaperTileLayer*> TileLayers;                                        // 0x05C8 (size: 0x10)
    FLinearColor TileMapColor;                                                        // 0x05D8 (size: 0x10)
    int32 UseSingleLayerIndex;                                                        // 0x05E8 (size: 0x4)
    bool bUseSingleLayer;                                                             // 0x05EC (size: 0x1)
    class UPaperTileMap* TileMap;                                                     // 0x05F0 (size: 0x8)
