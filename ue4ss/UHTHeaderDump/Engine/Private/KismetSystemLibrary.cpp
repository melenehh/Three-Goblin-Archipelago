...
FTopLevelAssetPath UKismetSystemLibrary::MakeTopLevelAssetPath(const FString& PackageName, const FString& AssetName) {
...
void UKismetSystemLibrary::BreakTopLevelAssetPath(const FTopLevelAssetPath& TopLevelAssetPath, FString& PathString) {
}
