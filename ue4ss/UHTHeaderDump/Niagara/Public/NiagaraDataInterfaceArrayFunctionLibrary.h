...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static void SetNiagaraArrayMatrixValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, const FMatrix& Value, bool bSizeToFit, bool bApplyLWCRebase);
    
    UFUNCTION(BlueprintCallable)
    static void SetNiagaraArrayMatrix(UNiagaraComponent* NiagaraSystem, FName OverrideName, const TArray<FMatrix>& ArrayData, bool bApplyLWCRebase);
    ...
    UFUNCTION(BlueprintCallable)
    static FMatrix GetNiagaraArrayMatrixValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, bool bApplyLWCRebase);
    
    UFUNCTION(BlueprintCallable)
    static TArray<FMatrix> GetNiagaraArrayMatrix(UNiagaraComponent* NiagaraSystem, FName OverrideName, bool bApplyLWCRebase);
