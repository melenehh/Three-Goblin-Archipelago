...
public:
    ...
    UFUNCTION(BlueprintCallable)
    virtual void SetNumberOfFrames(FFrameNumber NewLengthInFrames, bool bShouldTransact) PURE_VIRTUAL(SetNumberOfFrames,);
    
    UFUNCTION(BlueprintCallable)
    virtual void SetModel(TScriptInterface<IAnimationDataModel> InModel) PURE_VIRTUAL(SetModel,);
    ...
    UFUNCTION(BlueprintCallable)
    virtual void ResizeNumberOfFrames(FFrameNumber NewLengthInFrames, FFrameNumber T0, FFrameNumber T1, bool bShouldTransact) PURE_VIRTUAL(ResizeNumberOfFrames,);
    
    UFUNCTION(BlueprintCallable)
    virtual void ResizeInFrames(FFrameNumber NewLengthInFrames, FFrameNumber T0, FFrameNumber T1, bool bShouldTransact) PURE_VIRTUAL(ResizeInFrames,);
    ...
    UFUNCTION(BlueprintCallable)
    virtual TScriptInterface<IAnimationDataModel> GetModelInterface() const PURE_VIRTUAL(GetModelInterface, return NULL;);
    ...
    UFUNCTION(BlueprintCallable)
    virtual bool AddBoneCurve(FName BoneName, bool bShouldTransact) PURE_VIRTUAL(AddBoneCurve, return false;);
