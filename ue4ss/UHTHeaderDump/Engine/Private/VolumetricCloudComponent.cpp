...
UVolumetricCloudComponent::UVolumetricCloudComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->AerialPespectiveRayleighScatteringStartDistance = 0.00f;
    this->AerialPespectiveRayleighScatteringFadeDistance = 0.00f;
    this->AerialPespectiveMieScatteringStartDistance = 0.00f;
    this->AerialPespectiveMieScatteringFadeDistance = 0.00f;
}
