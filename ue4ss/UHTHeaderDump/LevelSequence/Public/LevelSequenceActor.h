...
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=WorldPartitionObjectResolver -FallbackName=WorldPartitionObjectResolver
//CROSS-MODULE INCLUDE V2: -ModuleName=Engine -ObjectName=WorldPartitionResolveData -FallbackName=WorldPartitionResolveData
...
class ALevelSequenceActor : public AActor, public IMovieScenePlaybackClient, public IMovieSceneBindingOwnerInterface, public IWorldPartitionObjectResolver {
    GENERATED_BODY()
public:
