...
struct FALoadingScreenSettings
{
    ...
    FTipSettings TipWidget;                                                           // 0x0130 (size: 0xB0)
    FLoadingWidgetSettings LoadingWidget;                                             // 0x01E0 (size: 0x320)
    EAsyncLoadingScreenLayout Layout;                                                 // 0x0500 (size: 0x1)
...
struct FLoadingCompleteTextSettings
{
    ...
    FTextAppearance Appearance;                                                       // 0x0018 (size: 0x98)
...
struct FLoadingWidgetSettings
{
    ...
    FText LoadingText;                                                                // 0x0038 (size: 0x18)
    bool bLoadingTextRightPosition;                                                   // 0x0050 (size: 0x1)
    bool bLoadingTextTopPosition;                                                     // 0x0051 (size: 0x1)
    FTextAppearance Appearance;                                                       // 0x0058 (size: 0x98)
    ...
    FMaterialThingSettings MaterialSettings;                                          // 0x02D8 (size: 0x30)
    FWidgetAlignment TextAlignment;                                                   // 0x0308 (size: 0x2)
    FWidgetAlignment LoadingIconAlignment;                                            // 0x030A (size: 0x2)
    float Space;                                                                      // 0x030C (size: 0x4)
    bool bHideLoadingWidgetWhenCompletes;                                             // 0x0310 (size: 0x1)

}; // Size: 0x320

struct FMaterialThingSettings
{
    FSoftObjectPath Material;                                                         // 0x0000 (size: 0x20)
    FVector2D Size;                                                                   // 0x0020 (size: 0x10)
...
struct FTextAppearance
{
    ...
    FVector2D ShadowOffset;                                                           // 0x0070 (size: 0x10)
    FLinearColor ShadowColorAndOpacity;                                               // 0x0080 (size: 0x10)
    TEnumAsByte<ETextJustify::Type> Justification;                                    // 0x0090 (size: 0x1)
...
struct FTipSettings
{
    ...
    FTextAppearance Appearance;                                                       // 0x0010 (size: 0x98)
    float TipWrapAt;                                                                  // 0x00A8 (size: 0x4)
    bool bSetDisplayTipTextManually;                                                  // 0x00AC (size: 0x1)
...
class ULoadingScreenSettings : public UDeveloperSettings
{
    ...
    FALoadingScreenSettings StartupLoadingScreen;                                     // 0x0040 (size: 0x510)
    FALoadingScreenSettings DefaultLoadingScreen;                                     // 0x0550 (size: 0x510)
    FClassicLayoutSettings Classic;                                                   // 0x0A60 (size: 0xF0)
    FCenterLayoutSettings Center;                                                     // 0x0B50 (size: 0xF0)
    FLetterboxLayoutSettings Letterbox;                                               // 0x0C40 (size: 0x1D0)
    FSidebarLayoutSettings Sidebar;                                                   // 0x0E10 (size: 0x100)
    FDualSidebarLayoutSettings DualSidebar;                                           // 0x0F10 (size: 0x1D0)
