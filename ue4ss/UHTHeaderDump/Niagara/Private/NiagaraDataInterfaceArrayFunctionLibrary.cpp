...
void UNiagaraDataInterfaceArrayFunctionLibrary::SetNiagaraArrayMatrixValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, const FMatrix& Value, bool bSizeToFit, bool bApplyLWCRebase) {
}

void UNiagaraDataInterfaceArrayFunctionLibrary::SetNiagaraArrayMatrix(UNiagaraComponent* NiagaraSystem, FName OverrideName, const TArray<FMatrix>& ArrayData, bool bApplyLWCRebase) {
}
...
FMatrix UNiagaraDataInterfaceArrayFunctionLibrary::GetNiagaraArrayMatrixValue(UNiagaraComponent* NiagaraSystem, FName OverrideName, int32 Index, bool bApplyLWCRebase) {
    return FMatrix{};
}

TArray<FMatrix> UNiagaraDataInterfaceArrayFunctionLibrary::GetNiagaraArrayMatrix(UNiagaraComponent* NiagaraSystem, FName OverrideName, bool bApplyLWCRebase) {
