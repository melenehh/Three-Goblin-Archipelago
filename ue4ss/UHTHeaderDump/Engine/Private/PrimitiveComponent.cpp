...
UPrimitiveComponent::UPrimitiveComponent(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->HLODBatchingPolicy = EHLODBatchingPolicy::None;
    this->bEnableAutoLODGeneration = true;
    this->bIsActorTextureStreamingBuiltData = false;
    ...
    this->bStaticWhenNotMoveable = true;
...
void UPrimitiveComponent::SetIgnoreBoundsForEditorFocus(bool bIgnore) {
}
...
bool UPrimitiveComponent::GetStaticWhenNotMoveable() const {
    return false;
}
...
bool UPrimitiveComponent::GetIgnoreBoundsForEditorFocus() const {
    return false;
}
