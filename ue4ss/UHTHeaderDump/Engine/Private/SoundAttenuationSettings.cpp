...
FSoundAttenuationSettings::FSoundAttenuationSettings() {
    ...
    this->NonSpatializedRadiusStart = 0.00f;
    this->NonSpatializedRadiusEnd = 0.00f;
    this->NonSpatializedRadiusMode = ENonSpatializedRadiusSpeakerMapMode::OmniDirectional;
