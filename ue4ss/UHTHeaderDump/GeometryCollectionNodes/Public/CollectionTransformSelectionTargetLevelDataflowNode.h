...
#include "CollectionTransformSelectionTargetLevelDataflowNode.generated.h"
...
public:
    ...
    GEOMETRYCOLLECTIONNODES_API FCollectionTransformSelectionTargetLevelDataflowNode();
};
