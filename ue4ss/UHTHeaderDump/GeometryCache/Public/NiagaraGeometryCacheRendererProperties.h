...
//CROSS-MODULE INCLUDE V2: -ModuleName=Niagara -ObjectName=ENiagaraRendererSourceDataMode -FallbackName=ENiagaraRendererSourceDataMode
//CROSS-MODULE INCLUDE V2: -ModuleName=Niagara -ObjectName=NiagaraRendererMaterialParameters -FallbackName=NiagaraRendererMaterialParameters
