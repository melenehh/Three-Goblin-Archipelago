...
public:
    ...
    UFUNCTION(BlueprintCallable)
    virtual FAssetData K2_GetAssetByObjectPath(const FSoftObjectPath& ObjectPath, bool bIncludeOnlyOnDiskAssets, bool bSkipARFilteredAssets) const PURE_VIRTUAL(K2_GetAssetByObjectPath, return FAssetData{};);
